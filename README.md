...
Actual Todoist dogfood is intentionally unverified in this public bootstrap when no safe local browser credential and authority are available. Local tests and builds prove the implementation contribution only; they do not prove provider acceptance or cutover.
